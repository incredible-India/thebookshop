...
app.get('/',isAuth.authUser,async (req,res)=>{
   ...
   if(isauth)
   {
      return res.status(200).render('index',{name : "hello",navTexts : {"My cart" : '/freebooks/show/mycart',"Notifications (5)" : '/mynotifications',"Requests" : "/bookshop/request","Services" : "/bookshop/services","logout" : '/newregistration/logout',"My Account" : "/newregistration/myaccount"},username : isauth.fname});
   }else
   {
